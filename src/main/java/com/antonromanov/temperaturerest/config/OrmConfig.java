...
@ComponentScan({"com.antonromanov.temperaturerest"})
@EnableJpaRepositories(basePackages = "com.antonromanov.temperaturerest.repository")
public class OrmConfig {
   ...
   /* *//**
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] {"com.antonromanov.temperaturerest.model"});
