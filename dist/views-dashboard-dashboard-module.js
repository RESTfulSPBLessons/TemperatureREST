...
/***/ "./src/app/arduinoStatus.ts":
/*!**********************************!*\
  !*** ./src/app/arduinoStatus.ts ***!
  \**********************************/
/*! exports provided: ArduinoStatus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ArduinoStatus", function() { return ArduinoStatus; });
var ArduinoStatus = /** @class */ (function () {
    function ArduinoStatus() {
    }
    Object.defineProperty(ArduinoStatus.prototype, "getAc", {
        get: function () {
            return this.isAcOn;
        },
        enumerable: true,
...
/* harmony import */ var _arduinoStatus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../arduinoStatus */ "./src/app/arduinoStatus.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(httpService) {
        ...
        this.radioModel = 'Day';
        this.diagramTitle = 'Day statistic';
        // ---------------------------------------------------------------- LOCAL --------------------------------------------------
        ...
        this.httpGetWeek = '/RCCT-2.0-SNAPSHOT/rest/users/week'; // дневные за неделю
        this.httpGetMonthly4Day = '/RCCT-2.0-SNAPSHOT/rest/users/month'; // месячные, дневная температуры
        this.httpGetStatus = '/RCCT-2.0-SNAPSHOT/rest/users/status'; // Статус
        this.mainChartData5 = []; // todo: переименовать
        this.year = []; // время измерения todo: переименовать
        this.year2 = []; // время измерения todo: переименовать
        this.count = []; // температура todo: переименовать
        this.count2 = []; // температура todo: переименовать
        this.label = []; // метки todo: переименовать
        this.person = {
            data: [],
            label: 'Temp = '
        };
        ...
        this.mainChartElements = 5;
        this.mainChartData1 = [];
        this.mainChartData2 = [];
        this.mainChartData3 = [];
        this.mainChartData = [this.person, this.person];
        this.mainChartLabels = ['Night', 'Morning', 'Day', 'Evening'];
    ...
    DashboardComponent.prototype.monthMode = function () {
        ...
        this.httpService.getData5(this.httpGetMonthly4Day).subscribe(function (data) {
            _this.temps = data;
            console.log(data);
            _this.temps.forEach(function (y) {
                _this.year.push(y.measureDate);
                _this.label.push((y.measureDate.split('/'))[0] + '/' + (y.measureDate.split('/'))[1]);
                _this.count.push(y.dayTemp);
                _this.count2.push(y.nightTemp);
            });
            console.log(_this.count);
            console.log(_this.year);
            _this.mainChartData = [];
    ...
    DashboardComponent.prototype.weekMode = function () {
        ...
        this.httpService.getData5(this.httpGetWeek).subscribe(function (data) {
            _this.temps = data;
            console.log(data);
            _this.temps.forEach(function (y) {
                _this.year.push(y.measureDate);
    ...
    DashboardComponent.prototype.getStatus = function () {
        ...
        this.httpService.getData7(this.httpGetStatus).subscribe(function (data) {
            _this.arduinoStatus = data;
            console.log(data);
        });
        if (this.arduinoStatus == null) {
            console.log('НЕТ СВЯЗИ');
            this.arduinoStatus = new _arduinoStatus__WEBPACK_IMPORTED_MODULE_5__["ArduinoStatus"]();
